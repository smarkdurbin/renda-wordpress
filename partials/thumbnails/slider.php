...
?>
    <!--Post Thumbnail-->
    <img src="<?php echo $image_md ?>" sizes="contain 100vh 100vw"  srcset=" <?php echo $image_xs; ?> 750w, <?php echo $image_sm; ?> 960w, <?php echo $image_md; ?> 1200w, <?php echo $image_lg; ?> 1500w, <?php echo $image_xl; ?> 2000w" class="img-responsive">
<?php
    }
?>