...
add_image_size('blog-featured-xs', 750, 500, true); // Blog Featured XS
add_image_size('blog-featured-sm', 750, 500, true); // Blog Featured SM
add_image_size('blog-featured-md', 675, 450, true); // Blog Featured MD
add_image_size('blog-featured-lg', 1125, 750, true); // Blog Featured LG
add_image_size('blog-featured-xl', 1500, 1000, true); // Blog Featured XL
add_image_size('blog-featured-full', true); // Blog Featured FULL

// declare thumbnail sizes
add_image_size('page-xs', 750, 500, true); // Page XS
add_image_size('page-sm', 960, 640, true); // Page SM
add_image_size('page-md', 1200, 600, true); // Page MD
add_image_size('page-lg', 1500, 750, true); // Page LG
add_image_size('page-xl', 2000, 1000, true); // Page XL
add_image_size('page-full', true); // Page FULL

// declare thumbnail sizes
add_image_size('slider-xs', 750, 375, true); // Slider XS
add_image_size('slider-sm', 960, 480, true); // Slider SM
add_image_size('slider-md', 1200, 600, true); // Slider MD
add_image_size('slider-lg', 1500, 750, true); // Slider LG
add_image_size('slider-xl', 2000, 1000, true); // Slider XL
add_image_size('slider-full', true); // Slider FULL
...
function register_menus()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'social-links' => 'Social Links', // Social Media Links
    ));
}
...
function enqueue_styles() {
    ...
    /** REGISTER css/jquery.bxslider.css **/
    wp_register_style( 'bxslider-style', THEME_DIR . '/css/jquery.bxslider.css', array(), '1', 'all' );
...
function enqueue_scripts() {
    ...
    /** REGISTER HTML5 bootstrap.min.js **/
    wp_register_script( 'bootstrap-script', THEME_DIR . '/js/bootstrap.min.js', array( 'jquery' ), '1', false );
    wp_enqueue_script( 'bootstrap-script' );
    
    /** REGISTER HTML5 jquery.bxslider.js **/
    wp_register_script( 'jquery-bxslider', THEME_DIR . '/js/jquery.bxslider.min.js', array( 'jquery' ), '1', false );
    wp_enqueue_script( 'jquery-bxslider' );
    
    /** REGISTER HTML5 mooz.scripts.min.js **/
    wp_register_script( 'mooz-scripts', THEME_DIR . '/js/mooz.scripts.min.js', array( 'jquery' ), '1', false );
    wp_enqueue_script( 'mooz-scripts' );
    
    /** REGISTER HTML5 scripts.js **/
...
function renda_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'blog_right',
		'before_widget' => '<div class="widget-non-theme sidebar-widget">',
		'after_widget'  => '</div>',
